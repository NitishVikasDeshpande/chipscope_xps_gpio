...
chipscope_icon icon(
	...
	.CLK(FSL_S_Clk),
	.DATA({video_wire_r,video_wire_g ,video_wire_b ,out_videor,out_videog,out_videob,rdy_wirer,rdy_wireg,rdy_wireb,rdy_state,rstr,rstg,rstb,data_32,    data_84, 84'b0 }),
	.TRIG0(rst)
	) ;
